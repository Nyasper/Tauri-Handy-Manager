...
- Los handies fijados ya no se pueden desvincular ni reasignar: hay que desfijarlos primero. El modal de asignación muestra un aviso con un botón **Desfijar**, el menú contextual deshabilita "Revocar Asignación" y "Reasignar handy" para ellos, y la capa de datos lo valida.
